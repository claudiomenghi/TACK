...
public class CLTLocIff  extends CLTLocFormula implements BinaryFormula<CLTLocFormula> {
	...
	public CLTLocIff(CLTLocFormula subformula1, CLTLocFormula subformula2) {
		super();
