...
public class Planner  {
	 ...
	 */
	public Planner( SystemDecl system, MITLIFormula mitliformula, int bound, PrintStream out) {
		...
		Preconditions.checkArgument(system.getTimedAutomata()!=null, "The system should contain at least a timed automaton");
		Preconditions.checkArgument(system.getTimedAutomata().size()>0, "The system should contain at least a timed automaton");
		this.system=system;
	...
	public boolean plan(CLTLocFormula additionalConstraints) throws IOException, ZotException {
		...
		timer.start();
		out.println("************************************************");
		out.println("Loading the MITLI formula:");
	...
	//	out.println("************************************************");
		out.println("************************************************");
		out.println("Converting the TAs in CLTLoc");
		
		out.print("Timed automata that will be converted:");
		
		system.getTimedAutomata().forEach(t-> out.print(t.getIdentifier()));
		...
		out.println("Timed automata converted in CLTLoc");
