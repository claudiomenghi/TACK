// $ANTLR 3.5 QTL.g 2013-04-04 16:16:24
...
public class QTLLexer extends Lexer {
	...
	public final void mF_OP() throws RecognitionException {
		try {
			int _type = F_OP;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// QTL.g:217:5: ( 'F_ee' | 'F_ei' | 'F_ii' | 'F_ie' )
			int alt1=4;
	...
	public final void mG_OP() throws RecognitionException {
		try {
			int _type = G_OP;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// QTL.g:220:5: ( 'G_ee' | 'G_ei' | 'G_ii' | 'G_ie' )
			int alt3=4;
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// QTL.g:238:3: ( ATOM ( ATOM | INT )* )
			// QTL.g:238:6: ATOM ( ATOM | INT )*
			{
			mATOM(); 

			// QTL.g:238:10: ( ATOM | INT )*
			loop8:
			while (true) {
				int alt8=3;
