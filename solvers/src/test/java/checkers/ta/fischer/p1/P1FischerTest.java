...
public class P1FischerTest {
	...
	public void test() throws IOException, ZotException {
		...
		String path = ClassLoader.getSystemResource("checkers/ta/fischer/p1/fischer_input_02.q").getPath();
		...
		ANTLRInputStream tainput = new ANTLRFileStream(
				ClassLoader.getSystemResource("checkers/ta/fischer/p1/fischer_input_02.ta").getPath());
