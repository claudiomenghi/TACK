...
public class FischerTest {
	...
	public void test() throws IOException, ZotException {
		...
		String path = ClassLoader.getSystemResource("checkers/ta/fischer/fischer_input_02.q").getPath();
		...
		ANTLRInputStream tainput = new ANTLRFileStream(
				ClassLoader.getSystemResource("checkers/ta/fischer/fischer_input_02.ta").getPath());
