...
public class P3FischerTest {
	...
	public void test() throws IOException, ZotException {
		...
		String path = ClassLoader.getSystemResource("tack/ta/fischer/p3/fischer_input_02.q").getPath();
		...
		ANTLRInputStream tainput = new ANTLRFileStream(
				ClassLoader.getSystemResource("tack/ta/fischer/p3/fischer_input_02.ta").getPath());
