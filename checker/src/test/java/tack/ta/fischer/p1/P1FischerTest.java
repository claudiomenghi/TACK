...
public class P1FischerTest {

	@Test
	public void test() throws IOException, ZotException {
	
		String path = ClassLoader.getSystemResource("tack/ta/fischer/p1/fischer_input_02.q").getPath();
		...
		ANTLRInputStream tainput = new ANTLRFileStream(
				ClassLoader.getSystemResource("tack/ta/fischer/p1/fischer_input_02.ta").getPath());
