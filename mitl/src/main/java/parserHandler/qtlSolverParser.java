...
public class qtlSolverParser extends Parser {
	public static final String[] tokenNames = new String[] { "<invalid>", "<EOR>", "<DOWN>", "<UP>", "AND_OP", "ATOM",
			"COLON", "COMMENT", "COUNT_OP", "FALSE", "F_OP", "F_inf_OP", "G_OP", "G_inf_OP", "H_OP", "ID", "IFF_OP",
			"IMPL_OP", "INT", "LBRA", "LOGIC", "LPAR", "NEG_OP", "NEWLINE", "OR_OP", "P_OP", "RBRA", "RELEASE_OP",
			"RPAR", "SEMI", "SINCE_OP", "TRIGGER_OP", "TRUE", "UNTIL_OP", "WS", "':bound'", "':def'", "':formula'" };
	...
	public String[] getTokenNames() {
		return qtlSolverParser.tokenNames;
	}
	...
	public final Formula tlparser() throws RecognitionException {
		...
		try {
			// qtlSolver.g:34:9: (l= logic NEWLINE ':bound' INT NEWLINE (
			// declaration )* ':formula' fmla NEWLINE )
		...
		try {
			...
			// qtlSolver.g:80:14: ':def' s= ID fmla NEWLINE
			{
				...
				if (memory.containsKey((s != null ? s.getText() : null)))
					emitErrorMessage("warning: duplicate name formula! " + (s != null ? s.getText() : null)
							+ " was already defined.");
				else
	...
	// $ANTLR start "fmla"
	// qtlSolver.g:92:1: fmla returns [Formula r] : ( LPAR in_fmla= fmla RPAR |
	// TRUE | FALSE | ID | LPAR NEG_OP f1= fmla RPAR | LPAR AND_OP clist=
	// conjuncts_list RPAR | LPAR OR_OP clist= conjuncts_list RPAR | LPAR
	// IMPL_OP f1= fmla f2= fmla RPAR | LPAR IFF_OP f1= fmla f2= fmla RPAR |
	// LPAR F_OP a= INT b= INT f1= fmla RPAR | LPAR F_inf_OP a= INT f1= fmla
	// RPAR | LPAR op= G_OP a= INT b= INT f1= fmla RPAR | LPAR op= G_inf_OP a=
	// INT f1= fmla RPAR | LPAR P_OP a= INT b= INT f1= fmla RPAR | LPAR H_OP a=
	// INT b= INT f1= fmla RPAR | LPAR UNTIL_OP f1= fmla f2= fmla RPAR | LPAR
	// SINCE_OP f1= fmla f2= fmla RPAR | LPAR RELEASE_OP f1= fmla f2= fmla RPAR
	// | LPAR TRIGGER_OP f1= fmla f2= fmla RPAR | LPAR COUNT_OP n= INT b= INT
	// f1= fmla RPAR );
	public final Formula fmla() throws RecognitionException {
		...
		try {
			// qtlSolver.g:93:2: ( LPAR in_fmla= fmla RPAR | TRUE | FALSE | ID |
			// LPAR NEG_OP f1= fmla RPAR | LPAR AND_OP clist= conjuncts_list
			// RPAR | LPAR OR_OP clist= conjuncts_list RPAR | LPAR IMPL_OP f1=
			// fmla f2= fmla RPAR | LPAR IFF_OP f1= fmla f2= fmla RPAR | LPAR
			// F_OP a= INT b= INT f1= fmla RPAR | LPAR F_inf_OP a= INT f1= fmla
			// RPAR | LPAR op= G_OP a= INT b= INT f1= fmla RPAR | LPAR op=
			// G_inf_OP a= INT f1= fmla RPAR | LPAR P_OP a= INT b= INT f1= fmla
			// RPAR | LPAR H_OP a= INT b= INT f1= fmla RPAR | LPAR UNTIL_OP f1=
			// fmla f2= fmla RPAR | LPAR SINCE_OP f1= fmla f2= fmla RPAR | LPAR
			// RELEASE_OP f1= fmla f2= fmla RPAR | LPAR TRIGGER_OP f1= fmla f2=
			// fmla RPAR | LPAR COUNT_OP n= INT b= INT f1= fmla RPAR )
			int alt3 = 20;
			switch (input.LA(1)) {
			case LPAR: {
				switch (input.LA(2)) {
			...
			// qtlSolver.g:250:6: LPAR F_OP a= INT b= INT f1= fmla RPAR
			{
				...
				if (tlogic.equals("mitl")) {
					if (s.compareTo("F_ei") == 0 || s.compareTo("F_ii") == 0)
						f = MITLFormula.F((MITLFormula) f1, Integer.valueOf((a != null ? a.getText() : null)),
								Integer.valueOf((b != null ? b.getText() : null)));
				} else if (tlogic.equals("mitl-i")) {
					if (s.compareTo("F_ei") == 0 || s.compareTo("F_ii") == 0)
						f = MITLIFormula.F((MITLIFormula) f1, Integer.valueOf((a != null ? a.getText() : null)),
								Integer.valueOf((b != null ? b.getText() : null)));
				}
			...
			// qtlSolver.g:309:6: LPAR op= G_OP a= INT b= INT f1= fmla RPAR
			{
				...
				if (tlogic.equals("mitl")) {
					if (s.compareTo("G_ei") == 0 || s.compareTo("G_ii") == 0)
						f = MITLFormula.G((MITLFormula) f1, Integer.valueOf((a != null ? a.getText() : null)),
								Integer.valueOf((b != null ? b.getText() : null)));
				} else if (tlogic.equals("mitl-i")) {
					if (s.compareTo("G_ei") == 0 || s.compareTo("G_ii") == 0)
						f = MITLIFormula.G((MITLIFormula) f1, Integer.valueOf((a != null ? a.getText() : null)),
								Integer.valueOf((b != null ? b.getText() : null)));
				}
			...
			// qtlSolver.g:368:6: LPAR P_OP a= INT b= INT f1= fmla RPAR
			{
				...
				if (tlogic.equals("mitl")) {
					...
					if (s.compareTo("P_ie") == 0 || s.compareTo("P_ii") == 0)
						f = MITLIFormula.P((MITLIFormula) f1, Integer.valueOf((a != null ? a.getText() : null)),
								Integer.valueOf((b != null ? b.getText() : null)));
				}
			...
			// qtlSolver.g:401:6: LPAR H_OP a= INT b= INT f1= fmla RPAR
			{
				...
				if (tlogic.equals("mitl")) {
					...
					if (s.compareTo("H_ei") == 0 || s.compareTo("H_ii") == 0)
						f = MITLIFormula.H((MITLIFormula) f1, Integer.valueOf((a != null ? a.getText() : null)),
								Integer.valueOf((b != null ? b.getText() : null)));
				}
	...
	// qtlSolver.g:491:1: conjuncts_list returns [List<Formula> l] : f1= fmla
	// (clist= conjuncts_list |) ;
	...
	public static final BitSet FOLLOW_conjuncts_list_in_conjuncts_list643 = new BitSet(
