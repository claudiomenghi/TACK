...
public class MITLIEventually_AtoB extends MITLIEventually implements TemporizedFormula {
	...
	public String translate(CLTLTranslator t) {
		...
		for (int i = 0; i < d; i++) {
			_f1[i] = t.and(t.rel("=", x(i, t), "0"), t.X(t.U(t.rel(">", x(i, t), "0"), t.and(subf.high(t),
								...
								t.and(orig,
										t.U(t.or(
												t.rel(">", x(0, t),
														"0"),
												orig),
												t.and(subf.interval(t),
														t.or(t.and(t.rel(">=", x(0, t), String.valueOf(a)),
																t.rel("<=", x(0, t), String.valueOf(b))),
																t.and(t.rel("<", x(0, t), String.valueOf(a)),
																		t.X(t.rel(">", x(0, t), String.valueOf(a))))))
		...
		for (int i = 0; i < d; i++) {
			_f4[i] = t.and(t.rel("=", x(i, t), "0"), t.X(t.U(t.rel(">", x(i, t), "0"), t.and(subf.low(t),
					t.rel("=", x(i, t), String.valueOf(a)),
					t.R(subf.high(t), t.neg(t.and(subf.high(t), t.rel("<=", x(i, t), String.valueOf(upperbound()))))

					)))));
		}

		String f4;
		f4 = t.iff(low(t), t.or(t.and(t.neg(orig), t.or(_f4)), t.and(orig, t.neg(high(t)))));
		...
		String f5 = t.implies(t.and(subf.low(t), t.R(subf.high(t), t.neg(t.and(subf.high(t),
