...
public class MITLIGlobally_ZerotoB extends MITLIGlobally_AtoB {
	...
	public String translate(CLTLTranslator t) {
				...
				t.or(
						t.and(t.neg(
								...
								t.or(t.and(
										t.rel("=", z0(t),
												"0"),
										t.X(t.U(t.rel(">", z0(t), "0"),
												t.and(subf.low(t), t.rel("=", z0(t), String.valueOf(upperbound())),
														t.or(t.rel(">", subf.z0(t), String.valueOf(upperbound())),
																t.rel(">", subf.z1(t),
																		String.valueOf(upperbound()))))))),
										t.and(t.rel("=", z1(t), "0"), t.X(t.U(t.rel(">", z1(t), "0"),
												t.and(subf.low(t), t.rel("=", z1(t), String.valueOf(upperbound())),
														t.or(t.rel(">", subf.z0(t), String.valueOf(upperbound())),
																t.rel(">", subf.z1(t),
																		String.valueOf(upperbound()))))))))),
						t.and(orig, t.U(t.or(orig, t.rel(">", z0(t), "0")),
								t.and(t.neg(subf.interval(t)), t.rel("<=", z0(t), String.valueOf(upperbound())))))));
		...
		f3 = t.iff(high(t),
				t.and(subf.high(t),
						t.R(subf.low(t),
								t.neg(t.and(subf.low(t), t.and(t.rel("<=", subf.z0(t), String.valueOf(upperbound())),
										t.rel("<=", subf.z1(t), String.valueOf(upperbound()))))))));
