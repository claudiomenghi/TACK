...
public interface TAVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link TAParser#declId}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclId(@NotNull TAParser.DeclIdContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link TAParser#fieldInit}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFieldInit(@NotNull TAParser.FieldInitContext ctx);
	/**
