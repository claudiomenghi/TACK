...
public class QTLConjunction extends QTLFormula {
	
		
	private QTLFormula subformula1, subformula2;
	
	public QTLConjunction(QTLFormula subformula1, QTLFormula subformula2){
	...
	public String translate(CLTLTranslator t) {
		...
		String befDnowU_C_p1 = t.or(t.and(subf1.high(t), subf1.lC(t)), subf1.singU(t)); 
		String befDnowU_C_p2 = t.or(t.and(subf2.high(t), subf2.lC(t)), subf2.singU(t)); 
		...
		String f1 = t.iff(
							...
							t.or(
									t.and(
											subf1.high(t),
											t.S(t.neg(nowOnD_p2), nowOnU_p2),
											t.or(subf1.lO(t), subf2.singD(t))
									),
									t.and(
											subf2.high(t),
											t.S(t.neg(nowOnD_p1), nowOnU_p1),
											t.or(subf2.lO(t), subf1.singD(t))
									)	 
								)
						);
		...
		String f2 = t.iff(
							t.and(low(t), lC(t)),
							t.or(
									t.and(subf1.low(t), t.Y(t.S(t.neg(nowOnD_p2), nowOnU_p2)), t.or(subf1.lC(t), subf2.singD(t))),
									t.and(subf2.low(t), t.Y(t.S(t.neg(nowOnD_p1), nowOnU_p1)), t.or(subf2.lC(t), subf1.singD(t))),
									t.and(orig, 
											t.or(
													t.and(subf1.low(t), t.or(subf1.lC(t), t.and(subf2.high(t), subf2.lO(t)))),
													t.and(subf2.low(t), t.or(subf2.lC(t), t.and(subf1.high(t), subf1.lO(t))))
												)
										 )									
								)
						 );
		...
		String f3 = t.iff(
							t.and(high(t), lC(t)),
							t.or(
									t.and(subf1.high(t), subf1.lC(t), t.neg(nowOnU_p2), t.S(t.neg(nowOnD_p2), nowOnU_p2)),
									t.and(subf2.high(t), subf2.lC(t), t.neg(nowOnU_p1), t.S(t.neg(nowOnD_p1), nowOnU_p1)),
									t.and(subf1.high(t), subf1.lC(t),subf2.high(t), subf2.lC(t))));
		...
		String f4 = t.iff(
							t.and(low(t), lO(t)),
							t.or(
									t.and(subf1.low(t), subf1.lO(t), t.or(
											 t.and(t.neg(nowOnU_p2), t.S(t.neg(nowOnD_p2), nowOnU_p2)),
											 t.and(orig, subf2.high(t), subf2.lC(t)))),
									t.and(subf2.low(t), subf2.lO(t), t.or(
											t.and(t.neg(nowOnU_p1), t.S(t.neg(nowOnD_p1), nowOnU_p1)),
											t.and(orig, subf1.high(t), subf1.lC(t)))),
									t.and(subf1.low(t), subf1.lO(t),subf2.low(t), subf2.lO(t))));
	...
	public Formula simplify() {		
		return new QTLConjunction((QTLFormula)subformula1.simplify(), (QTLFormula)subformula2.simplify());
	}
