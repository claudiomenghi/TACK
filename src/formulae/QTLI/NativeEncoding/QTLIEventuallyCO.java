...
public class QTLIEventuallyCO extends QTLIFormula implements Temporized {

	private QTLIFormula subformula;
	private final int b;  
	
	public QTLIEventuallyCO(QTLIFormula subformula, int b){
		super(new String("(Fco " + String.valueOf(b) + " " + subformula.strFormula() + ")"));
	...
	public Formula simplify() {
		return new QTLIEventuallyCO((QTLIFormula)subformula.simplify(), b);
	}
