...
public class QTLIDisjunction extends QTLIFormula {
	
		
	private QTLIFormula subformula1, subformula2;
	
	public QTLIDisjunction(QTLIFormula subformula1, QTLIFormula subformula2){
	...
	public String translate(CLTLTranslator t) {
		...
		String f1 = t.and(
							t.iff(point(t), t.or(subf1.point(t), subf2.point(t))),
							t.iff(interval(t), t.or(subf1.interval(t), subf2.interval(t)))
					);
	...
	public Formula simplify() {		
		return new QTLIDisjunction((QTLIFormula)subformula1.simplify(), (QTLIFormula)subformula2.simplify());
	}
